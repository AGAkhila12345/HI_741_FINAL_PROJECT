...
def main():
    ...
    credentials_file = r"C:\Users\USER\OneDrive\Desktop\PA3\PA3_credentials.csv"
    patients_file = r"C:\Users\USER\OneDrive\Desktop\PA3\PA3_data.csv"
    ...
    while True:
        if user.role in ['admin', 'management']:
            ...
            if choice == "1":
                ...
                patient_information['Visit_time'] = input("Enter Visit_time (D/M/YYYY): ")
