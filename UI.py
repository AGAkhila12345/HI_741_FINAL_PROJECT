...
class Application(tk.Tk):
    def __init__(self):
        ...
        self.credentials_file = "PA3_credentials.csv"
        self.patients_file = "PA3_data.csv"
        self.user = None
        self.patient_records = None
        self.usage_notes_file = "PA3_Notes.csv"
    ...
    def count_visits(self):
        date_str = simpledialog.askstring(
            "Count Visits", "Enter the date (MM/DD/YYYY):")
        if date_str:
            try:
                ...
                messagebox.showerror(
                    "Error", "Invalid date format; Please enter date in MM/DD/YYYY format")
